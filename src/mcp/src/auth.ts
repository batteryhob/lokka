import { AccessToken, TokenCredential, ClientSecretCredential, ClientCertificateCredential, InteractiveBrowserCredential, DeviceCodeCredential, DeviceCodeInfo, useIdentityPlugin, AuthenticationRecord, serializeAuthenticationRecord, deserializeAuthenticationRecord } from "@azure/identity";
...
function saveAuthenticationRecord(record: AuthenticationRecord): void {
  try {
...
function loadAuthenticationRecord(): AuthenticationRecord | undefined {
  try {
